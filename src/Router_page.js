...
import Notes_page, { Subjectname } from "./components/We_Offer/Notes/Notes_page"
...
import Subjectnotespage from './components/We_Offer/Notes/Subjectnotespage'
...
export default function () {
  return (
    ...
    <Routes>
        ...
        <Route path='/Notes/:branch/:year/:subject' element={<Subjectnotespage/>}/>
    </Routes>
    </BrowserRouter>
